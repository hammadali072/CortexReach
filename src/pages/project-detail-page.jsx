...
import LeadSourcingModal from '../components/ui/leadSourcingModal/leadSourcingModal';
import ImportSuccessToast from '../components/ui/importSuccessToast/importSuccessToast';
...
const ProjectDetailPage = () => {
        ...
        { name: 'Relevance', selector: row => row.relevance, sortable: true, cell: row => (
            <div className="w-full max-w-[100px] py-2">
                ...
                <div className="h-1.5 w-full bg-slate-100 rounded-full overflow-hidden shadow-inner">
                    <div className="h-full bg-gradient-brand rounded-full transition-all duration-500" style={{ width: `${row.relevance}%` }} />
                </div>
            </div>
        )},
    ...
    if (dbLoading) return (
        <div className="flex flex-col items-center justify-center py-40 gap-6">
            <div className="size-12 border-4 border-slate-100 border-t-primary rounded-xl animate-spin" />
    ...
    if (dbError) return (
        <div className="py-20 text-center space-y-6">
            <div className="size-20 bg-red-50 rounded-[32px] flex items-center justify-center mx-auto text-red-500 shadow-xl shadow-red-100/50">
    ...
    if (!project) return (
        <div className="py-20 text-center space-y-6">
            <div className="size-20 bg-slate-50 rounded-[32px] flex items-center justify-center mx-auto text-slate-200"><i className="fas fa-search text-3xl" /></div>
