    ...
    return (
        <div className="max-w-6xl mx-auto space-y-8 pb-20">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    <TitleComponent type="h1" className="text-3xl font-black font-idGrotesk bg-gradient-brand bg-clip-text text-transparent">
                        Account Settings
                    </TitleComponent>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">
                <div className="lg:col-span-3">
                    <div className="bg-white rounded-2xl border border-slate-200 p-1.5 shadow-sm sticky top-8 flex lg:flex-col overflow-x-auto lg:overflow-x-visible no-scrollbar">
                        {TABS.map((tab) => {
                            const Icon = tab.icon;
