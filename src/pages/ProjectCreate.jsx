        ...
        <div className="w-full space-y-8 pb-12">
            <div className="flex items-center justify-between">
                ...
                <Link to="/dashboard/projects">
                    <Button variant="outline" size="small" className="rounded-md px-4">
            ...
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-[40px] shadow-sm border border-slate-100 p-10 space-y-8">
                    ...
                    <div>
                        ...
                        <textarea
                            rows={3}
                            className="w-full p-6 bg-slate-50 border border-slate-100 rounded-md focus:ring-2 focus:ring-indigo-500 focus:bg-white outline-none transition-all font-medium text-slate-700"
                            ...
                            {formData.features.map((feature, index) => (
                                <div key={index} className="flex gap-3 animate-in fade-in slide-in-from-left-2 duration-300">
                                    <div className="flex-1 relative">
                                        ...
                                        <input
                                            type="text"
                                            className="w-full pl-10 pr-6 py-4 bg-slate-50 border border-slate-100 rounded-md focus:ring-2 focus:ring-indigo-500 focus:bg-white outline-none transition-all font-medium text-slate-700"
