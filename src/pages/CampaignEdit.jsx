            ...
            {formData.status === 'draft' ? (
                <form onSubmit={handleSubmit} className="bg-white rounded-[40px] shadow-sm border border-slate-100 p-10 space-y-8">
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            className="w-full p-6 bg-slate-50 border border-slate-100 rounded-[32px] focus:ring-2 focus:ring-indigo-500 outline-none transition-all font-medium text-slate-700 min-h-[300px]"
                            value={formData.body}
                ...
                <div className="bg-white rounded-[40px] shadow-sm border border-slate-100 p-10 text-center">
