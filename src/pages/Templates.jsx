...
const Templates = () => {
    ...
    const fetchTemplates = async () => {
        try {
            ...
            // Phase 5: Automatic Seeding logic
            // If the database has no templates and we haven't tried seeding this session
    ...
    /**
     * Internal function to seed presets automatically
     */
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            // Manually re-fetch to ensure sync after save
        ...
        <div className="space-y-12 pb-20 animate-in fade-in duration-500">
            ...
            >
                <div className="p-8 space-y-6">
                    ...
                    <div className="space-y-2">
                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Default Subject Line</label>
                        <Input 
                            placeholder="e.g. Quick question for {{firstName}}"
                            value={formData.subject}
                            onChange={(e) => setFormData({ ...formData, subject: e.target.value })}
                        />
                        <p className="text-[10px] text-slate-400 italic">Variables: {'{{firstName}}'}, {'{{lastName}}'}, {'{{companyName}}'}</p>
                    </div>

                    <div className="space-y-2">
                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Content Editor</label>
                        <div className="rounded-2xl border border-slate-100 overflow-hidden shadow-inner bg-white">
                            <RichTextEditor 
                                value={formData.body}
