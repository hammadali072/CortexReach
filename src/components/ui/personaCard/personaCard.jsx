...
const PersonaCard = ({ title, role, industry, painPoints, relevance }) => {
    return (
        <div className="bg-white rounded-lg p-6 border border-slate-100 shadow-sm hover:shadow-md transition-all group overflow-hidden relative">
            <div className="absolute top-0 right-0 w-24 h-24 bg-indigo-50 rounded-lg[100px] -mr-10 -mt-10 group-hover:bg-indigo-100 transition-colors" />
            ...
            <div className="relative z-10">
                ...
                <div className="flex items-center gap-2 mb-4">
                    <div className="size-6 rounded-lg bg-slate-50 flex items-center justify-center">
                    ...
                    <ul className="space-y-2">
                        {painPoints.map((point, index) => (
                            <li key={index} className="flex items-start gap-2">
                                <div className="mt-1.5 w-1 h-1 rounded-lg bg-indigo-400 flex-shrink-0" />
