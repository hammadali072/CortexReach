...
const ImportSuccessToast = ({ count, onClose }) => (
    ...
    >
        {/* Icon */}
        <div className="size-10 bg-emerald-500 rounded-lg flex items-center justify-center flex-shrink-0 shadow-lg shadow-emerald-200">
        ...
        <button
            ...
            className="flex-shrink-0 size-6 flex items-center justify-center rounded-lg text-slate-300 hover:text-slate-500 hover:bg-slate-50 transition-all"
        >
