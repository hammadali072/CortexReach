...
const PersonaCard = ({ title, role, industry, painPoints, relevance }) => {
    return (
        <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm hover:shadow-md transition-all group overflow-hidden relative">
            <div className="absolute top-0 right-0 w-24 h-24 bg-indigo-50 rounded-bl-[100px] -mr-10 -mt-10 group-hover:bg-indigo-100 transition-colors"></div>
