      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          {PRESET_COLORS.map((c) => {
            ...
            return (
              <button
                ...
                className={clsx(
                  'size-8 rounded-full transition-all duration-150 flex items-center justify-center focus:outline-none',
                  isActive
          ...
          <div className="relative flex items-center">
            {/* Color preview dot */}
            <div
              className="size-6 rounded-full border-2 border-white shadow-sm mr-2 flex-shrink-0"
