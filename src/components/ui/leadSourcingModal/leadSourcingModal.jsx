        ...
        >
            <div className="space-y-6 py-4">
                <div className="p-4 bg-indigo-50 border border-indigo-100 rounded-lg flex items-start gap-4">
                    <div className="size-10 bg-indigo-600 rounded-lg flex items-center justify-center flex-shrink-0 shadow-lg shadow-indigo-200">
                ...
                <div className="grid grid-cols-1 gap-5">
                    <div className="space-y-2">
                        <label 
                            ...
                            className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1 cursor-pointer"
                        >
                            Select Priority Persona
                        </label>
                        <select
                            id="persona-select"
                            value={persona}
