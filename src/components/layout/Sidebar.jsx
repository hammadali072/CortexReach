            ...
            <aside className={clsx(
                ...
                <div className="border-t border-gray-100 p-6 bg-gray-50/50 relative">
                    ...
                    <div className="relative group">
                        ...
                        {showAccountDropdown && (
                            <div className="absolute bottom-full left-0 w-full mb-4 bg-white rounded-lg shadow-2xl border border-gray-100 overflow-hidden animate-in fade-in slide-in-from-bottom-2 duration-200 z-50">
                                <div className="p-2">
                                    <button
                                        onClick={async () => {
                                            await logout();
