                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div className="hidden md:flex items-center relative group">
                        ...
                        <input
                            ...
                            className="pl-10 pr-4 py-2 w-64 lg:w-96 bg-gray-50 border border-gray-100 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:bg-white transition-all"
                        />
                    </div>
                </div>
                ...
                <div className="flex items-center space-x-6">
                    ...
                    <div className="relative" ref={notificationRef}>
                        <button
                            ...
                            className={`relative text-gray-500 hover:text-indigo-600 transition-all duration-300 focus:outline-none p-2 rounded-xl ${showNotifications ? 'bg-indigo-50 text-indigo-600' : ''}`}
                        >
                            <i className="fas fa-bell text-lg" />
                            <span className="absolute top-1 right-1 w-4 h-4 bg-indigo-600 rounded-full text-[10px] text-white flex items-center justify-center border-2 border-white">
